 ...
 * @author JamesAllen
 */
public class CreepBlackAnt extends Creep {
    
    public CreepBlackAnt(CandyMagicPanel cmp, int mx, int my, int hp, int ms, boolean inv, boolean detected, int bnty, int sl, BufferedImage creepEggImage) {
